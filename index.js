...
const popupButtonExit = popup.querySelector(".popup__button-exit");
const titileCard_1 = card_1.querySelector(".card__title");
const titileCard_2 = card_2.querySelector(".card__title");
const titileCard_3 = card_3.querySelector(".card__title");
...
card_1.addEventListener("click", function () {
  popupTitle.textContent = titileCard_1.textContent;
...
card_2.addEventListener("click", function () {
  popupTitle.textContent = titileCard_2.textContent;
...
card_3.addEventListener("click", function () {
  popupTitle.textContent = titileCard_3.textContent;
