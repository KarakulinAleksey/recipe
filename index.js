...
card_1.addEventListener('click', function(){
    description.innerHTML = `15 ноября в мире отмечают День шоколадного кекса.
...
card_2.addEventListener('click', function(){
    ...
    Печенье появилось одновременно с хлебом. Но соревноваться с ним в популярности не могло. 
...
card_3.addEventListener('click', function(){
    description.innerHTML = `Первая версия гласит, что трюфели были созданы кондитером Луи Дюфуру в 1895 году 
